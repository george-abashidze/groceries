...
public class ManagerListHeaderBinder implements HeaderBindingInterface<ManagerProductListHeaderBinding> {
    ...
    ManagerProductListHeaderBinding binding;

    public ManagerListHeaderBinder(HeaderEvents events) {
        this.events = events;
    ...
    @Override
    public void bind(ManagerProductListHeaderBinding binding,Filter filter) {
    ...
    public List<Category> getCategories(){
        return categoryAdapter.getItems();
    }
